...
def extracting_directories(subdirectory_path, model, parent_directory, inner_subdirectory):
    ...
    # Save the aggregated transcription to a text file in the subdirectory
    subdirectory_name = os.path.basename(subdirectory_path)
    aggregated_transcription_file_path = os.path.join(subdirectory_path,
                                                      f"{parent_directory}-{subdirectory_name}.trans")
...
if __name__ == "__main__":
    ...
    for subdirectory in os.listdir(directory):
        ...
        if os.path.isdir(subdirectory_path):
            ...
            print("Transcribed")  # Indicate that transcription is done for this directory

    # Write all CER results to a CSV file on the desktop
